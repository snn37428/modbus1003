...
public class DevicesManagement {
    ...
    public static void main(String[] args) {
         ...
         * STEP1: 添加新的PLC设备
         */
        int nServerListPos = manager.add("192.168.1.1", Modbus.DEFAULT_PORT);
...
//                // -- tested --
//                //0.设置系统参数
//                ans.setConvertMode(ModbusProtocol.DATATYPE_REAL32, ModbusProtocol.CONVMOD_0123_3210,
...
//    				float data = ans.getFloatByIndex(i);
	    				System.out.println(i+":----" + data);
//                        System.out.println(i+":**float***" + data2);
	    			}
    			}
